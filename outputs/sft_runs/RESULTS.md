...
- [`docs/HF_SETUP.md`](../../docs/HF_SETUP.md) — login and license steps
- [`scripts/hpc_sft_rich.sh`](../../scripts/hpc_sft_rich.sh) — one-command HPC run
...
```bash
# Once per account (see docs/HF_SETUP.md):
huggingface-cli login
# Accept licenses for gemma-3n-E4B-it and gemma-2-9b-it on huggingface.co

# Qwen 7B (proposal qwen3.5-9b proxy):
bash scripts/hpc_sft_rich.sh qwen7b outputs/sft_runs/qwen7b_rich

# Gemma 3n E4B (proposal gemma-4-e4b proxy); if LoRA fails, use gemma2_9b:
bash scripts/hpc_sft_rich.sh gemma3n_e4b outputs/sft_runs/gemma3n_rich
bash scripts/hpc_sft_rich.sh gemma2_9b outputs/sft_runs/gemma2_9b_rich
```
...
PYTHONPATH=src python src/sft/main.py +sft_models=qwen7b sft_device=cuda \
