...
MLeRP: [dsks_2025.08](https://docs.mlerp.cloud.edu.au/usage/environments/dsks/dsks_2025.08.html) + `pip install --user` extras. Local: `.venv`.
...
Details: [HF_SETUP.md](HF_SETUP.md)
